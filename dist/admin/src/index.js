...
exports.default = {
    register: function (app) {
        ...
        app.customFields.register({
            name: "uuid",
            pluginId: pluginId_1.default,
            type: "string",
            intlLabel: {
                id: (0, helpers_1.getTrad)("form.label"),
                defaultMessage: "Advanced UUID",
            },
            intlDescription: {
                id: (0, helpers_1.getTrad)("form.description"),
                defaultMessage: "Generates a UUID v4",
            },
            icon: InputIcon_1.default,
            components: {
                Input: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                    return [2 /*return*/, Promise.resolve().then(function () { return __importStar(require(/* webpackChunkName: "input-uuid-component" */ "./components/Input")); })];
                }); }); },
            },
            options: {
                base: [
                    {
                        intlLabel: {
                            id: (0, helpers_1.getTrad)("form.field.uuidFormat"),
                    ...
                    {
                        intlLabel: {
                            id: (0, helpers_1.getTrad)("form.field.disableRegenerate"),
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(locales.map(function (locale) {
                                return Promise.resolve("".concat("./translations/".concat(locale, ".json"))).then(function (s) { return __importStar(require(s)); }).then(function (_a) {
                                    var data = _a.default;
                                    return {
